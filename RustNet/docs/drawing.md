...
| Format | Support |
|---|---|
| BMP | uncompressed 24-bit and 32-bit `BITMAPINFOHEADER`, top-down or bottom-up (managed) |
| GIF | 87a/89a, global/local colour table, **LZW** decompression, interlaced frames de-interlaced (first frame) (managed) |
